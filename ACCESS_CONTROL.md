...
- `free`: trial expired and no active subscription. The tender list is a ten-project read-only preview; every interaction and email delivery require a subscription.
