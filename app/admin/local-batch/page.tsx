  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-6 px-5 py-8 sm:px-8 lg:py-10">
      <AdminPageHeader
        eyebrow="Local batch"
        title="本地批量分析"
        description="把下载好的标书放进一个文件夹，填路径即可——文件不经过浏览器上传。系统会按文件内的招标编号自动归属到对应项目，一个项目的多个文件合并分析后写回一句话总结、资质、业绩、文件要求、风险，以及标书里的投标日程（关键日期）——日程里的交标截止日只在项目本身没有时才填，且会先检查日程是否自相矛盾。同一文件按内容哈希去重，不会重复付费。"
