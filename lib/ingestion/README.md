...
| Proyectos México (Banobras/SHCP national priority projects) | Browser CSV export button (the page's own filter/export, no anti-bot gate) | `npm run ingest:proyectos-mexico -- <file>.csv --write` |
