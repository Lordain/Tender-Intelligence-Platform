      ...
      <div className="border-b border-white/10">
        <div className="mx-auto max-w-[94rem] px-5 sm:px-8">
          <div className="flex h-[4.75rem] items-center justify-between gap-3 sm:gap-6">
            ...
            <div className="flex shrink-0 items-center gap-3 sm:gap-6 xl:gap-8">
              <AuthNav />
              <NotificationBell />
            </div>
          </div>

          <nav className="flex items-center gap-1 overflow-x-auto border-t border-white/10 py-2 sm:justify-between lg:hidden">
            {links.map(([href, label]) => (
