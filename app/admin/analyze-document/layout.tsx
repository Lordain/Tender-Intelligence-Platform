...
// requirements/risks to Supabase, so it needs the strict allowlist check.
export default async function AdminAnalyzeDocumentLayout({ children }: { children: React.ReactNode }) {
