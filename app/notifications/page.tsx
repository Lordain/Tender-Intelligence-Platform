  ...
  return (
    <main className="flex-1 bg-[#f7f4ee]">
      <div className="mx-auto w-full max-w-6xl px-5 py-12 sm:px-8 sm:py-16">
        ...
        {entitlement?.role === "trial" && <div className="mt-6 rounded-2xl border border-[#efcf80] bg-[#fff7df] px-5 py-4 text-sm font-bold text-[#805100]">{TRIAL_DAYS} 天免费试用期间通知功能已开放；试用结束且未订阅时将自动停止发送。</div>}
