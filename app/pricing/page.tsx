  ...
  return (
    <main className="bg-[#f6f4ef] px-5 py-6 sm:px-8 sm:py-8">
      <div className="mx-auto max-w-[94rem]">
        <PageIntro eyebrow="Subscription plans" title="订阅服务" description={`注册即开启 ${TRIAL_DAYS} 天全功能试用；试用结束后可按个人或企业协作需求订阅。`} metrics={[{ label: "注册即享", value: String(TRIAL_DAYS), suffix: "天全功能试用" }]} />
        <PricingPlans />
